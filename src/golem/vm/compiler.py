...
from golem.values import BoolVal, ErrorVal, FloatVal, IntVal, StringVal, UnitVal, Value
...
def _compile(expr: object, ch: Chunk, locs: _LocEnv) -> ErrorVal | None:
    from golem.ast import HoleExpr, IdentExpr, MatchExpr, OpExpr
    from golem.runtime_ops import RUNTIME_OPS
...
def _subst_ident(expr: object, name: str, repl: object) -> object:
    ...
    from golem.ast import CallExpr, IdentExpr, IfExpr, MatchCase, MatchExpr, OpExpr

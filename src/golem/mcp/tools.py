"""MCP tool handlers for the Golem compiler (Phase 12)."""

from __future__ import annotations

from typing import Any, Callable

from golem.ai_ffi import constrain, type_from_air
from golem.canonical import print_canonical
from golem.edits import get_at
from golem.kb import retrieve as kb_retrieve
from golem.llm_out import format_for_llm
from golem.parser import ParseError, parse_expr, parse_program
from golem.partial import CompileStatus, compile_check, evaluate
from golem.values import ErrorVal, IntVal, StringVal, Value
from golem.vm import run as vm_run
...
def tool_constrain(args: dict) -> dict:
    ...
    if isinstance(raw, bool):
        from golem.values import BoolVal

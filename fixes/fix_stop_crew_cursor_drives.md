# fix: stop 4B crew; Cursor drives Knot
...
## Fix
Author direction (2026-09-11): stop using the crew for implementation. Cursor (this session) implements Knot directly against the phase specs and design doc. Local-only crew scripts remain gitignored for optional experiments; they are not the build path.
